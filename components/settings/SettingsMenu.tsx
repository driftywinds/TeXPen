...
export const SettingsMenu: React.FC = () => {
    ...
    return (
        <div className="relative" ref={menuRef}>
            ...
            {/* Dropdown Menu */}
            {isSettingsOpen && (
                <div className="absolute right-0 top-full mt-3 w-64 max-h-[80vh] bg-white dark:bg-[#111] border border-black/10 dark:border-white/10 rounded-2xl shadow-xl backdrop-blur-xl z-50 flex flex-col animate-in fade-in zoom-in-95 duration-200 origin-top-right overflow-hidden">
